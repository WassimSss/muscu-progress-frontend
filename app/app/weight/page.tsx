...
export default function Page() {
  ...
  const handleSubmit = async () => {
    const response = await fetch("http://localhost:8080/users/weights/add", {
      method: "POST",
      headers: {
  ...
  const getWeights = useCallback(async () => {
    const response = await fetch("http://localhost:8080/users/weights/get", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
  ...
  const getProgram = useCallback(async () => {
    const response = await fetch("http://localhost:8080/users/programs/get", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
