...
export default function InputWithLabel({ label, type, placeholder, required = true, id, name, className, value, onChange, active = true, minLength, maxLength, handleKeyPress }: InputWithLabelProps) {
