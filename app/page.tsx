...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col mt-24 md:p-24 gap-2 px-4">
      ...
      <p className=" text-neutral-600 text-sm md:text-md lg:text-lg font-bold text-center">Entrez vos exercices, vos series, vos poids, vos dates et constatez votre progression</p>
